...
type ServiciosPlomeriaRouteProp = RouteProp<RootStackParamList, "ServiciosPlomeria">;

const ServiciosPlomeria: React.FC = () => {
  const { session } = useAuth();
  const navigation = useNavigation<NativeStackNavigationProp<RootStackParamList>>();
  const route = useRoute<ServiciosPlomeriaRouteProp>();
      ...
      <View style={styles.container}>
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            <Ionicons name="water" size={64} color="#ccc" />
...
export default ServiciosPlomeria;
